...
RSpec.describe "Api::V1::ScenarioExecutions", type: :request do
  ...
  describe "GET /api/v1/projects/:project_id/features/:feature_id/scenarios/:scenario_id/scenario_executions" do
    ...
    context "with expired token" do
      ...
      it "returns unauthorized" do
        get "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions", headers: api_headers(expired_user.api_token)
        expect(response).to have_http_status(:unauthorized)
        expect(json_response["error"]).to eq("Unauthorized")
      end
    end
    ...
    context "with valid authentication" do
      ...
      it "returns scenario executions for scenario" do
        get "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions", headers: api_headers(user.api_token)
      ...
      context "when project does not exist" do
        it "returns 404" do
          get "/api/v1/projects/99999/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions", headers: api_headers(user.api_token)
      ...
      context "when feature does not exist" do
        it "returns 404" do
          get "/api/v1/projects/#{project.id}/features/99999/scenarios/#{scenario.id}/scenario_executions", headers: api_headers(user.api_token)
          expect(response).to have_http_status(:not_found)
      ...
      context "when scenario does not exist" do
        it "returns 404" do
          get "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/99999/scenario_executions", headers: api_headers(user.api_token)
          expect(response).to have_http_status(:not_found)
      ...
      context "when user is not a member of the project" do
        ...
        it "returns 404" do
          get "/api/v1/projects/#{other_project.id}/features/#{other_feature.id}/scenarios/#{other_scenario.id}/scenario_executions", headers: api_headers(other_user.api_token)
          expect(response).to have_http_status(:not_found)
          expect(json_response["error"]).to eq("Project not found")
        end
      end
  ...
  describe "GET /api/v1/projects/:project_id/features/:feature_id/scenarios/:scenario_id/scenario_executions/:id" do
    ...
    context "with valid authentication" do
      it "returns scenario execution details" do
        get "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions/#{scenario_execution.id}", headers: api_headers(user.api_token)
        expect(response).to have_http_status(:ok)
      ...
      context "when scenario execution does not exist" do
        it "returns 404" do
          get "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions/99999", headers: api_headers(user.api_token)
          expect(response).to have_http_status(:not_found)
      ...
      context "when scenario execution belongs to different scenario" do
        ...
        it "returns 404" do
          get "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions/#{other_execution.id}", headers: api_headers(user.api_token)
          expect(response).to have_http_status(:not_found)
          expect(json_response["error"]).to eq("Scenario execution not found")
        end
      end
    ...
    context "with valid authentication" do
      context "as viewer" do
        ...
        it "returns 403 forbidden" do
          post "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions", params: valid_params, headers: api_headers(user.api_token)
      ...
      context "as editor" do
        ...
        context "with validation errors" do
          it "defaults to pending status when status is not provided" do
            ...
            post "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions", params: invalid_params, headers: api_headers(user.api_token)
            expect(response).to have_http_status(:created)
        ...
        context "when project does not exist" do
          it "returns 404" do
            post "/api/v1/projects/99999/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions", params: valid_params, headers: api_headers(user.api_token)
            expect(response).to have_http_status(:not_found)
            expect(json_response["error"]).to eq("Project not found")
          end
        end
        ...
        context "when scenario does not exist" do
          it "returns 404" do
            post "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/99999/scenario_executions", params: valid_params, headers: api_headers(user.api_token)
            expect(response).to have_http_status(:not_found)
            expect(json_response["error"]).to eq("Scenario not found")
          end
        end
  ...
  describe "PATCH /api/v1/projects/:project_id/features/:feature_id/scenarios/:scenario_id/scenario_executions/:id" do
    ...
    context "with valid authentication" do
      context "as viewer" do
        ...
        it "returns 403 forbidden" do
          patch "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions/#{scenario_execution.id}", params: update_params, headers: api_headers(user.api_token)
          expect(response).to have_http_status(:forbidden)
          expect(json_response["error"]).to eq("Access denied")
        end
      end
      ...
      context "as editor" do
        ...
        context "with validation errors" do
          it "fails with invalid status" do
            ...
            patch "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions/#{scenario_execution.id}", params: invalid_params, headers: api_headers(user.api_token)
            expect(response).to have_http_status(:unprocessable_entity)
            expect(json_response["errors"]).to be_present
          end
        ...
        context "when scenario execution does not exist" do
          it "returns 404" do
            patch "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions/99999", params: update_params, headers: api_headers(user.api_token)
            expect(response).to have_http_status(:not_found)
            expect(json_response["error"]).to eq("Scenario execution not found")
          end
        end
  ...
  describe "DELETE /api/v1/projects/:project_id/features/:feature_id/scenarios/:scenario_id/scenario_executions/:id" do
    ...
    context "with valid authentication" do
      context "as viewer" do
        ...
        it "returns 403 forbidden" do
          delete "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions/#{scenario_execution.id}", headers: api_headers(user.api_token)
          expect(response).to have_http_status(:forbidden)
          expect(json_response["error"]).to eq("Access denied")
        end
      end
      ...
      context "as editor" do
        ...
        context "when scenario execution does not exist" do
          it "returns 404" do
            delete "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}/scenario_executions/99999", headers: api_headers(user.api_token)
            expect(response).to have_http_status(:not_found)
            expect(json_response["error"]).to eq("Scenario execution not found")
          end
        end
