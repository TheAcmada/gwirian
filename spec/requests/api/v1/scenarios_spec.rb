...
RSpec.describe "Api::V1::Scenarios", type: :request do
  ...
  describe "GET /api/v1/projects/:project_id/features/:feature_id/scenarios" do
    ...
    context "with expired token" do
      ...
      it "returns unauthorized" do
        get "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios", headers: api_headers(expired_workspace_member.api_token)
        expect(response).to have_http_status(:unauthorized)
        expect(json_response["error"]).to eq("Unauthorized")
      end
    end
    ...
    context "with valid authentication" do
      ...
      it "returns scenarios for feature" do
        get "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios", headers: api_headers(workspace_member.api_token)
      ...
      context "when project does not exist" do
        it "returns 404" do
          get "/api/v1/projects/99999/features/#{feature.id}/scenarios", headers: api_headers(workspace_member.api_token)
      ...
      context "when feature does not exist" do
        it "returns 404" do
          get "/api/v1/projects/#{project.id}/features/99999/scenarios", headers: api_headers(workspace_member.api_token)
          expect(response).to have_http_status(:not_found)
      ...
      context "when user is not a member of the project" do
        ...
        it "returns 404" do
          get "/api/v1/projects/#{other_project.id}/features/#{other_feature.id}/scenarios", headers: api_headers(other_workspace_member.api_token)
          expect(response).to have_http_status(:not_found)
          expect(json_response["error"]).to eq("Project not found")
        end
      end
  ...
  describe "GET /api/v1/projects/:project_id/features/:feature_id/scenarios/:id" do
    ...
    context "with valid authentication" do
      it "returns scenario details" do
        get "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}", headers: api_headers(workspace_member.api_token)
        expect(response).to have_http_status(:ok)
      ...
      context "when scenario does not exist" do
        it "returns 404" do
          get "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/99999", headers: api_headers(workspace_member.api_token)
          expect(response).to have_http_status(:not_found)
      ...
      context "when scenario belongs to different feature" do
        ...
        it "returns 404" do
          get "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{other_scenario.id}", headers: api_headers(workspace_member.api_token)
          expect(response).to have_http_status(:not_found)
          expect(json_response["error"]).to eq("Scenario not found")
        end
      end
      ...
      context "as editor" do
        ...
        context "with validation errors" do
          it "fails with missing title" do
            ...
            post "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios", params: invalid_params, headers: api_headers(workspace_member.api_token)
        ...
        context "when project does not exist" do
          it "returns 404" do
            post "/api/v1/projects/99999/features/#{feature.id}/scenarios", params: valid_params, headers: api_headers(workspace_member.api_token)
            expect(response).to have_http_status(:not_found)
            expect(json_response["error"]).to eq("Project not found")
          end
        end
        ...
        context "when feature does not exist" do
          it "returns 404" do
            post "/api/v1/projects/#{project.id}/features/99999/scenarios", params: valid_params, headers: api_headers(workspace_member.api_token)
            expect(response).to have_http_status(:not_found)
            expect(json_response["error"]).to eq("Feature not found")
          end
        end
      ...
      context "as editor" do
        ...
        context "with validation errors" do
          it "fails with missing title" do
            ...
            patch "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/#{scenario.id}", params: invalid_params, headers: api_headers(workspace_member.api_token)
            expect(response).to have_http_status(:unprocessable_entity)
            expect(json_response["errors"]).to be_present
            expect(json_response["errors"]).to include("Title can't be blank")
          end
        ...
        context "when scenario does not exist" do
          it "returns 404" do
            patch "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/99999", params: update_params, headers: api_headers(workspace_member.api_token)
            expect(response).to have_http_status(:not_found)
            expect(json_response["error"]).to eq("Scenario not found")
          end
        end
  ...
  describe "DELETE /api/v1/projects/:project_id/features/:feature_id/scenarios/:id" do
    ...
    context "with valid authentication" do
      ...
      context "as editor" do
        ...
        context "when scenario does not exist" do
          it "returns 404" do
            delete "/api/v1/projects/#{project.id}/features/#{feature.id}/scenarios/99999", headers: api_headers(workspace_member.api_token)
            expect(response).to have_http_status(:not_found)
            expect(json_response["error"]).to eq("Scenario not found")
          end
        end
